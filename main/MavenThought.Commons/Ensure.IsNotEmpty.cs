...
namespace MavenThought.Commons
{
    public partial class Ensure
    {
        ...
        public static void IsNotNullOrEmpty(string s, string msg, params object[] args)
        {
        ...
        public static void IsNotEmpty(IEnumerable collection, string msg, params object[] args)
        {
        ...
        public static void IsNotEmpty<T>(IEnumerable<T> collection, string msg, params object[] args)
        {
